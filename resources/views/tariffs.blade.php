	...
	<section>
        <div class="container fleet-text">
			...
			<br/>
			 ...
			 <div class="row">
				<div class="col-lg-12 text-center underline">
				</div>
			</div>
            <h3>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Our Clients</h3>
			<br/>
			<br/>
			<div class="row">
				<div class="col-sm-12 fleet-carousel">
				  ...
				  <div class="carousel-inner" role="listbox">
					<div class="item active">
						<div class="col-sm-offset-1 col-sm-2">
							<img src="images/clients/adityabirla.png" class="img-responsive">
						</div>
						<div class="col-sm-2">
							<img src="images/clients/bhel.png" class="img-responsive">
						</div>
						<div class="col-sm-2">
							<img src="images/clients/cadbury.png" class="img-responsive">
						</div>
						<div class="col-sm-2">
							<img src="images/clients/daburindia.png" class="img-responsive">
						</div>
						<div class="col-sm-2">
							<img src="images/clients/forbes.png" class="img-responsive">
						</div>
					</div>

					<div class="item">
						<div class="col-sm-offset-1 col-sm-2">
							<img src="images/clients/gmr.png" class="img-responsive">
						</div>
						<div class="col-sm-2">
							<img src="images/clients/gohnson&amp;gohnson.png" class="img-responsive">
						</div>
						<div class="col-sm-2">
							<img src="images/clients/google.png" class="img-responsive">
						</div>
						<div class="col-sm-2">
							<img src="images/clients/hdfc.png" class="img-responsive">
						</div>
						<div class="col-sm-2">
							<img src="images/clients/ibm.png" class="img-responsive">
						</div>
					</div>

					<div class="item">
						<div class="col-sm-offset-1 col-sm-2">
							<img src="images/clients/icici.png" class="img-responsive">
						</div>
						<div class="col-sm-2">
							<img src="images/clients/kpmg.png" class="img-responsive">
						</div>
						<div class="col-sm-2">
							<img src="images/clients/microsoft.png" class="img-responsive">
						</div>
						<div class="col-sm-2">
							<img src="images/clients/novartis.png" class="img-responsive">
						</div>
						<div class="col-sm-2">
							<img src="images/clients/rbi.png" class="img-responsive">
						</div>
					</div>

					<div class="item">
						<div class="col-sm-offset-1 col-sm-2">
							<img src="images/clients/sony.png" class="img-responsive">
						</div>
						<div class="col-sm-2">
							<img src="images/clients/tata.png" class="img-responsive">
						</div>
						<div class="col-sm-2">
							<img src="images/clients/thehindu.png" class="img-responsive">
						</div>
						<div class="col-sm-2">
							<img src="images/clients/wipro.png" class="img-responsive">
						</div>
						<div class="col-sm-2">
							<img src="images/clients/rbi.png" class="img-responsive">
						</div>
				  ...
				  <a class="left carousel-control" href="tariffs.html#myCarousel" role="button" data-slide="prev">
					<span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
					<span class="sr-only">Previous</span>
				  </a>
				  <a class="right carousel-control" href="tariffs.html#myCarousel" role="button" data-slide="next">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-offset-1 col-sm-8 text-center">
					<h4>For a stress free charter experience, call 91 40 23 32 32 32</h4>
                </div>
				<div class="col-sm-2 text-center">
                   <a class="btn btn-success"href="contactus.php.html">Enquire Now</a>
                </div>
            </div>
        </div>
    </section> 
			...
			<div class="col-sm-4 line-right">
			 ...
			 <h5>Quick Links</h5>
				...
				<ul class="list-unstyled">
					...
					<a href="tariffs.html#" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Careers</a>
					...
					<li><a href="tariffs.html#">Terms and Conditions</a></li>
				</ul>
				</div>
				<div class="col-xs-6">
				<ul class="list-unstyled">
			...
			<div class="col-sm-4">
				...
				<br/>
					<div class="col-xs-4 line2-right">
						<a href="http://www.driven.in/" target="_blank"><img src="images/selfdrive.png" class="img-responsive" alt=""></a>
					</div>
					<div class="col-xs-4 line2-right">
